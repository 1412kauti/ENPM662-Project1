...
class KeyboardControlNode(Node):
    ...
    def __init__(self):
        ...
        self.lidar_velocity_pub = self.create_publisher(Float64MultiArray, '/lidar_controller/commands', 10)
    ...
    def run_keyboard_control(self):
        ...
        lidar_velocities = Float64MultiArray()
        linear_vel=0.0
        steer_angle=0.0
        lidar_vel=0.0
        ...
        while True:
            ...
            if key is not None:
                ...
                self.lidar_velocity_pub.publish(lidar_velocities)
